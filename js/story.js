  ...
  constructor() {
    ...
    this.dialogues = {
      4: [
        ...
        {
          character: "mrs_claus",
          text: "Dear, the toys are all mixed up! Could you help organize them please?",
          portrait: "👵",
        },
        {
          character: "santa",
      ...
      10: [
        ...
        {
          character: "mrs_claus",
          text: "Solve this, and the workshop will be perfectly organized!",
          portrait: "👵",
        },
        {
          character: "santa",
          text: "You've been amazing! Thank you for helping us prepare for Christmas! You've helped make a lot of young boys and girls happy!",
          portrait: "🎅",
        },
      ],
    };
